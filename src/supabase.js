...
export function normalizeLease(row) {
  ...
  return {
    ...
    passingRentSqm: row.passing_rent_sqm != null ? row.passing_rent_sqm : null,
    passingRentTotal: row.passing_rent_total != null ? row.passing_rent_total : null,
    passingRentUpdated: row.passing_rent_updated ?? null,
    passingRentInvoice: row.passing_rent_invoice ?? '',
